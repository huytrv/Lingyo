        ...
        postMedia[i].onclick = function(){
            ...
            <div class="modal-content view-post-modal-content d-flex">
                <div class="close-view-post-modal return-but"><span class="iconify" data-icon="heroicons-outline:arrow-left" data-inline="false"></span></div>
                    <img src="https://cdn.fodance.com/cf-media/${postMedia[i].getAttribute("src")}" class="view-post-img">
                </div>
            </div>
            </div>
        `)
        ...
        for(let i = 0; i < posts.length; i++){
            ...
            <div class="pre-post-media">
                ${(()=>{if (posts[i].file.type == "video") {return `
                    <video muted controls src="https://cdn.fodance.com/cf-media/${posts[i].file.path[0]}"></video>
                `}
                else {return `
                ${(()=>{if (posts[i].file.path.length == 1){return `
                    <div class="post-file">
                        <img src="https://cdn.fodance.com/cf-media/${posts[i].file.path[0]}" class="media-post post-image">
                    </div>
                `}
                    ...
                    <div class="post-file thumb-2-files">
                        ...
                        <div class="thumb-file">
                            <img src="https://cdn.fodance.com/cf-media/${posts[i].file.path[1]}" class="media-post post-image">
                        </div>
                    </div>
                `}
                    ...
                    <div class="post-file thumb-3-files">
                        ...
                        <div class="thumb-file">
                            <img src="https://cdn.fodance.com/cf-media/${posts[i].file.path[2]}" class="media-post post-image">
                        </div>
                    </div>
                `}
                    ...
                    <div class="post-file thumb-4-files">
                        ...
                        <div class="thumb-file">
                            <img src="https://cdn.fodance.com/cf-media/${posts[i].file.path[3]}" class="media-post post-image">
                        </div>
                    </div>
                `}
                })()}
