                                ...
                                if (res.videos.length == 0){
                                    ...
                                    if (videoDisplayedList.length <= res.total){
                                        ...
                                        for(let i = 0; i < res.videos.length; i++){
                                            document.querySelector(".media-content").insertAdjacentHTML('beforeend', `<div class="video-item"><video poster="/public/images/poster.png" src="https://cdn.fodance.com/fd-media/${res.videos[i]}" class="profile-videos"></video><div>`)
                                        }
