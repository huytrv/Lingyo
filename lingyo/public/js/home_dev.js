            ...
            <div class='post-user'>
                <div class="post-info">
                    <a class='avt'>
                        ...
                        <img src="${document.querySelector(".avt-rank").getAttribute("src")}" class="avt-rank ${document.querySelector(".avt-rank").getAttribute("src")}">
                    </a>
                    <div class='avt-info'>
                            ...
                            for(let i = 0; i < res.data.cmts.length; i++) {
                                ...
                                function showTextarea(focus, tag, tagUsername){
                                    ...
                                    if (comment.querySelectorAll(".comment-textarea-frame").length == 0){
                                        comment.querySelector(".rep-comment").insertAdjacentHTML('beforeend', `<div class="comment-textarea-frame d-flex-start pd-b mg-t-sm"><a class="avt d-flex rep-avt-small"><img src="${document.querySelectorAll(".user-avt")[0].getAttribute('src')}"><img src="${document.querySelectorAll(".avt-rank")[0].getAttribute('src')}" class="avt-rank ${document.querySelectorAll(".avt-rank")[0].getAttribute('src')}"></a><textarea type="text" name="comment" class="mg-l-sm comment-textarea rep-comment-textarea d-flex-col" maxlength="1000" placeholder="Viết bình luận..."></textarea><button class="comment-emoji-but comment-emoji rep-comment-emoji-but emoji-but d-flex"><span class="iconify" data-icon="bi:emoji-smile" data-inline="false"></span></button></div></div></div>`)
