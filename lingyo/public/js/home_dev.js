...
let rankIndex = 5, cateSort = "foryou-sort-content", rankLink = rankLinkPost = "primary", rankName = "Sơ cấp", filter = "current"
...
const navList = ["competition", "fame", "notifications", "saved", "community", "add-topic", "setting"]
const navName = ["Vòng đấu", "Xếp hạng", "Thông báo", "Đã lưu", "Cộng đồng", "Thêm thể loại", "Cài đặt"]
                        ...
                        <div class="search-item border-b nav-red" nav-data='personal' data-user-df="${res.result[i][2]}" data-user-id="${res.result[i][0]}">
                            <div class="d-flex-sb">
                                <div class="d-flex">
                                    ...
                                    <a class="avt"><img src="${res.result[i][3]}" class="user-avt" username="${res.result[i][1]}">
                                    <img src="https://cdn.lingyo.vn/lingyo-media/${res.result[i][6]}.png" class="avt-rank ${res.result[i][6]}"></a>
                                    `}
                                    else {return `
                                    <a class="avt"><img src="https://cdn.lingyo.vn/lingyo-media/${res.result[i][3]}" class="user-avt" username="${res.result[i][1]}">
                                    <img src="https://cdn.lingyo.vn/lingyo-media/${res.result[i][6]}.png" class="avt-rank ${res.result[i][6]}"></a>
                                    `}
                                    })()}
                                ...
                                <div class="d-flex-col-start">
                                    <div class="d-flex-start">
                                        ...
                                        <div class="d-flex-col-start">
                                            ...
                                            <div class="noselect"><span>Bạn đã xác thực tài khoản thành công! Giờ đây bạn đã có thể đăng video tham gia bình chọn trên Lingyo, cảm ơn bạn đã tham gia xác thực tài khoản!</span>
                                                </div>
                                            `}
                                            })()}
                                        </div>
                            ...
                            `)
                                ...
                                <div class="notification-item unread-notification-bg border-b nav-red" nav-data='view-post' data-post-df="${res.notifications[i].postInfo[0]}">
                                    <div class="d-flex-start">
                                        ...
                                        <div class="d-flex-col-start">
                                            ${(()=>{if (res.notifications[i].postInfo[1] == '1' && res.notifications[i].postInfo[2] != '') {return `<div><b>${res.notificationName}</b> đã bình chọn video của bạn tại Thể loại ${res.notifications[i].postInfo[2]} cấp ${res.notifications[i].postInfo[3]}</div>`} else if (res.notifications[i].postInfo[1] == '1' && !res.notifications[i].postInfo[2] == '') {return `<div><b>${res.notificationName}</b> đã yêu thích bài viết của bạn</div>`} else if (res.notifications[i].postInfo[1] != '1' && res.notifications[i].postInfo[2] != '') {return `<div><b>${res.notificationName}</b> và ${res.notifications[i].postInfo[1] - 1} người khác đã bình chọn video của bạn tại Thể loại ${res.notifications[i].postInfo[2]} cấp ${res.notifications[i].postInfo[3]}</div>`} else if (res.notifications[i].postInfo[1] != '1' && res.notifications[i].postInfo[2] == '') {return `<div><b>${res.notificationName}</b> và ${res.notifications[i].postInfo[1] - 1} người khác đã yêu thích bài viết của bạn</div>`}})()}
                                        </div>
                                    </div>
                                    <div class="time-noti">
                                    ${(() => {if ((Date.now() - Date.parse(res.notifications[i].time))/1000 < 5) {return `<span class="theme-color">Vừa xong</span>`} else if((Date.now() - Date.parse(res.notifications[i].time))/1000 > 5 && (Date.now() - Date.parse(res.notifications[i].time))/1000 < 60) {return `<span class="theme-color">${Math.floor((Date.now() - Date.parse(res.notifications[i].time))/1000)} giây trước</span>`} else if ((Date.now() - Date.parse(res.notifications[i].time))/1000/60 >= 1 && (Date.now() - Date.parse(res.notifications[i].time))/1000/60 < 60){return `<span class="theme-color">${Math.floor((Date.now() - Date.parse(res.notifications[i].time))/1000/60)} phút trước</span>`} else if ((Date.now() - Date.parse(res.notifications[i].time))/1000/3600 >= 1 && (Date.now() - Date.parse(res.notifications[i].time))/1000/3600 < 24){return `${Math.floor((Date.now() - Date.parse(res.notifications[i].time))/1000/3600)} giờ trước`} else if ((Date.now() - Date.parse(res.notifications[i].time))/1000/3600/24 >= 1 && (Date.now() - Date.parse(res.notifications[i].time))/1000/3600/24 < 8){return `${Math.floor((Date.now() - Date.parse(res.notifications[i].time))/1000/3600/24)} ngày trước`} else if ((Date.now() - Date.parse(res.notifications[i].time))/1000/3600/24 >= 8) {return `${new Date(res.notifications[i].time).getDate() + " tháng " + (new Date(res.notifications[i].time).getMonth() + 1) + " lúc " + new Date(res.notifications[i].time).getHours() + ':' + new Date(res.notifications[i].time).getMinutes()}`}})()}
                                ...
                                <div class="notification-item unread-notification-bg border-b nav-red" nav-data='view-post' data-post-df="${res.notifications[i].postInfo[0]}" data-cmt-df="${res.notifications[i].postInfo[1]}">
                                    <div class="d-flex-start">
                                        ...
                                        <div class="d-flex-col-start">
                                            ${(()=>{if (res.notifications[i].postInfo[4] == '0' && res.notifications[i].postInfo[2] != '') {return `<div><b>${res.notificationName}</b> đã bình luận về video của bạn tại Thể loại ${res.notifications[i].postInfo[2]} cấp ${res.notifications[i].postInfo[3]}</div>`} else if (res.notifications[i].postInfo[4] == '0' && !res.notifications[i].postInfo[2] == '') {return `<div><b>${res.notificationName}</b> đã bình luận về bài viết của bạn</div>`} else if (res.notifications[i].postInfo[4] != '0' && res.notifications[i].postInfo[2] != '') {return `<div><b>${res.notificationName}</b> và ${res.notifications[i].postInfo[4]} người khác đã bình luận về video của bạn tại Thể loại ${res.notifications[i].postInfo[2]} cấp ${res.notifications[i].postInfo[3]}</div>`} else if (res.notifications[i].postInfo[4] != '0' && res.notifications[i].postInfo[2] == '') {return `<div><b>${res.notificationName}</b> và ${res.notifications[i].postInfo[4]} người khác đã bình luận về bài viết của bạn</div>`}})()}
                                        </div>
                                    </div>
                                    <div class="time-noti">
                                        ${(() => {if ((Date.now() - Date.parse(res.notifications[i].time))/1000 < 5) {return `<span class="theme-color">Vừa xong</span>`} else if((Date.now() - Date.parse(res.notifications[i].time))/1000 > 5 && (Date.now() - Date.parse(res.notifications[i].time))/1000 < 60) {return `<span class="theme-color">${Math.floor((Date.now() - Date.parse(res.notifications[i].time))/1000)} giây trước</span>`} else if ((Date.now() - Date.parse(res.notifications[i].time))/1000/60 >= 1 && (Date.now() - Date.parse(res.notifications[i].time))/1000/60 < 60){return `<span class="theme-color">${Math.floor((Date.now() - Date.parse(res.notifications[i].time))/1000/60)} phút trước</span>`} else if ((Date.now() - Date.parse(res.notifications[i].time))/1000/3600 >= 1 && (Date.now() - Date.parse(res.notifications[i].time))/1000/3600 < 24){return `${Math.floor((Date.now() - Date.parse(res.notifications[i].time))/1000/3600)} giờ trước`} else if ((Date.now() - Date.parse(res.notifications[i].time))/1000/3600/24 >= 1 && (Date.now() - Date.parse(res.notifications[i].time))/1000/3600/24 < 8){return `${Math.floor((Date.now() - Date.parse(res.notifications[i].time))/1000/3600/24)} ngày trước`} else if ((Date.now() - Date.parse(res.notifications[i].time))/1000/3600/24 >= 8) {return `${new Date(res.notifications[i].time).getDate() + " tháng " + (new Date(res.notifications[i].time).getMonth() + 1) + " lúc " + new Date(res.notifications[i].time).getHours() + ':' + new Date(res.notifications[i].time).getMinutes()}`}})()}
                    ...
                    if (document.querySelector(".follow-suggestion-content")){
                        ...
                        if (res.topSuggestion.length == 0){
                            ...
                            for (let i = 0; i < res.topSuggestion.length; i++){
                                ...
                                <img src="https://cdn.lingyo.vn/lingyo-media/${res.profileSuggestion[i].rank}.png" class="avt-rank ${res.profileSuggestion[i].rank}">                       
                                `}
                                else {return `
                        ...
                        function initVideoPlayerHolder(){
                            for (let i = 0; i < res.posts.length; i++){
                                if (document.querySelectorAll(".img-holder").length == 0){
                                    document.querySelector(".gallery-container").insertAdjacentHTML("beforeend", `<div class="img-holder"><div class="player-holder"><span class="iconify img-holder-play-but" data-icon="ant-design:play-circle-twotone" data-inline="false"></span></div><video playsinline webkit-playsinline><source></video><span class="caption-text">Top 1</span></div>`)
                                ...
                                for (let i = 0; i < holder.length; i++){
                                    ...
                                    holder[i].ondblclick = function(){
                                        if (document.querySelectorAll(".player-holder-modal").length == 0){
                                            ...
                                            holder[i].insertAdjacentHTML("afterend", `<div class='modal player-holder-modal'><div class='modal-content player-holder-modal-content d-flex-col'><h2 class='d-flex'>${holder[i].querySelector(".caption-text").textContent}</h2><div class="player-video-wrapper"><video class="player player-video-modal" loop muted playsinline webkit-playsinline>${holder[i].querySelector("video").innerHTML}</div><h3 class="d-flex mg-t"><a class="theme-color">Xem bài viết</a></h3></div></div></div>`)
    ...
    xhttp.onreadystatechange = function() {  
        if (xhttp.readyState == 4 && xhttp.status == 200) {
            ...
            for (let i = 0; i < sortEle.length; i++){
                if (i==0){sortEle[i].classList.add("sort-content-but-active")}
            ...
            <div class='post-user'>
                <div class="post-info">
                    <a class='avt'>
                        ...
                        <img src="${document.querySelector(".avt-rank").getAttribute("src")}" class="avt-rank ${document.querySelector(".avt-rank").className}">
                    </a>
                    <div class='avt-info'>
                    ...
                    if (i == l - 1 && fileValid == 0) {
                        for (let i = 0, f; f = files[i]; i++) {
                            ...
                            if (f.type.match('video.*')) {
                                fileCate = 2
                                ele.innerHTML = `<video class="thumb player" loop muted playsinline webkit-playsinline controls src="${src}#t=3"></video>
                                                <button class='close-thumb close-thumb' type='button'><span class='iconify dropdown-icon' data-icon='feather:x' data-inline='false'></span></button>`
                                if(document.querySelectorAll(".thumb-preview").length == 0) {
                                    document.querySelector(".thumb-content").insertBefore(ele, null)
                                }
                            ...
                            for(let i = 0; i < res.data.cmts.length; i++) {
                                ...
                                function showTextarea(focus, tag, tagUsername){
                                    ...
                                    if (comment.querySelectorAll(".comment-textarea-frame").length == 0){
                                        comment.querySelector(".rep-comment").insertAdjacentHTML('beforeend', `<div class="comment-textarea-frame d-flex-start pd-b mg-t-sm"><a class="avt d-flex rep-avt-small"><img src="${document.querySelectorAll(".user-avt")[0].getAttribute('src')}"><img src="${document.querySelectorAll(".avt-rank")[0].getAttribute('src')}" class="avt-rank ${document.querySelectorAll(".avt-rank")[0].className}"></a><textarea type="text" name="comment" class="mg-l-sm comment-textarea rep-comment-textarea d-flex-col" maxlength="1000" placeholder="Viết bình luận..."></textarea><button class="comment-emoji-but comment-emoji rep-comment-emoji-but emoji-but d-flex"><span class="iconify" data-icon="bi:emoji-smile" data-inline="false"></span></button></div></div></div>`)
                                ...
                                if (res.status == 'done'){
                                    ...
                                    comment.querySelector(".rep-comment-but").onclick = function(){
                                        ...
                                        if (!comment.querySelector(".rep-comment") && !cmtId){
                                            ...
                                            comment.querySelector(".rep-comment").insertAdjacentHTML('beforeend', `<div class="comment-textarea-frame d-flex-start pd-b mg-t-sm"><a class="avt d-flex rep-avt-small"><img src="${document.querySelectorAll(".user-avt")[0].getAttribute('src')}"><img src="${document.querySelectorAll(".avt-rank")[0].className}" class="avt-rank ${document.querySelectorAll(".avt-rank")[0].getAttribute('src')}"></a><textarea type="text" name="comment" class="mg-l-sm comment-textarea rep-comment-textarea d-flex-col" maxlength="1000" placeholder="Viết bình luận..."></textarea><button class="comment-emoji-but comment-emoji rep-comment-emoji-but emoji-but d-flex"><span class="iconify" data-icon="bi:emoji-smile" data-inline="false"></span></button></div></div></div>`)
                                            areaHandle(".rep-comment-textarea", ".rep-comment-emoji-but")  
                                            const repCmtTextarea = comment.querySelector(".rep-comment-textarea")
...
function handleMainFrame(){
    ...
    function handleSortContent(){
        ...
        function handleSortAjax(item, filter){
            ...
            if(window.innerWidth <= 662){
                ...
                if (cateSort == "foryou-sort-content"){sortType = "Cho bạn"}
        ...
        //                 const but = document.querySelector(".sort-content-but[sort-data='foryou-sort-content']")
        //                 document.querySelector(".sort-content-but[sort-data='foryou-sort-content']").classList.add("sort-content-but-active")
    ...
    function handleVideoScroll(){
        ...
        function countVideoImpressions(post){
            let xhttp
            if (window.XMLHttpRequest) {
                xhttp = new XMLHttpRequest()
            } else {
            ...
            xhttp.open("POST", '/video-impressions-scription', true)
            xhttp.setRequestHeader('Content-Type', 'application/json')
            xhttp.send(JSON.stringify(data))
        }
        ...
        if (elementInViewport2(vds[0])) {
            ...
            if (!impessionAjaxSend[0]){
                countVideoImpressions(document.querySelectorAll("video.player")[0].parentNode.parentNode.parentNode.parentNode.parentNode.getAttribute("data-post-df"))
                impessionAjaxSend[0] = true
            }
                ...
                if (buf != j){
                    ...
                    if (!paused[buf]) {
                        if (vds[buf].paused){
                            ...
                            if (!impessionAjaxSend[buf]){
                                countVideoImpressions(document.querySelectorAll("video.player")[buf].parentNode.parentNode.parentNode.parentNode.parentNode.getAttribute("data-post-df"))
                                impessionAjaxSend[buf] = true
                            }
    ...
    if (document.querySelectorAll(".post-section").length != 0 && document.querySelectorAll(".post-section .post").length < 5 && document.querySelector(".loading-post")) {
        ...
        if (window.location.pathname != "/saved"){
            if (window.location.pathname == "/community"){
                document.querySelector(".loading-post").innerHTML = `<div class="no-post-text"><div>Oops! Chưa có biến mới!</div><div class="no-post-lottie"></div></div><button class="create-post-but" data-create-but="layout">Tạo bài viết mới!</button>`
                lottie()
            }
            else {
        ...
        document.querySelector(".user-auth").onclick = function(){
            ...
            if (document.querySelectorAll(".user-auth-modal").length == 0){
                ...
                document.querySelector(".confirm-but").onclick = function(){
                    ...
                    <div class="d-flex"><h4 class="face-request pd">Hãy chờ một chút trong khi ứng dụng truy cập camera. Nếu không, hãy xác thực trên trình duyệt của bạn tại https://lingyo.vn</h4></div>
                    </div></div></div>`)
...
function viewMediaRedirect(e, media, pushState){
    if (media == "photo"){
        ...
        if (window.innerWidth <= 662) {
            ...
            <div class="modal-content view-post-modal-content d-flex">
                <div class="close-view-post-modal return-but"><span class="iconify" data-icon="heroicons-outline:arrow-left" data-inline="false"></span></div>
                    <video src="${e.getAttribute("src")}" loop muted playsinline webkit-playsinline poster="/public/images/poster.png" class="view-post-img profile-video-view player">
                </div>
            </div>
            </div>
        `)
            ...
            <div class="modal-content view-post-modal-content d-flex">
                <button class="close close-view-post-modal" type="button"><span class="iconify dropdown-icon" data-icon="feather:x" data-inline="false"></span></button>
                    <video loop muted playsinline webkit-playsinline poster="/public/images/poster.png" src="${e.getAttribute("src")}" class="view-post-img profile-video-view player">
                </div>
            </div>
            </div>
        `)
                                ...
                                if (res.videos.length == 0){
                                    ...
                                    if (videoDisplayedList.length <= res.total){
                                        ...
                                        for(let i = 0; i < res.videos.length; i++){
                                            document.querySelector(".media-content").insertAdjacentHTML('beforeend', `<div class="video-item"><video loop muted playsinline webkit-playsinline poster="/public/images/poster.png" src="https://cdn.lingyo.vn/lingyo-media/${res.videos[i]}#t=3" class="profile-videos"></video><div>`)
                                        }
