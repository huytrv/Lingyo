            ...
            <div class='post-user'>
                <div class="post-info">
                    <a class='avt'>
                        ...
                        <img src="https://cdn.lingyo.vn/lingyo-media/${document.querySelector(".avt-rank").getAttribute("src")}.png" class="avt-rank ${document.querySelector(".avt-rank").getAttribute("src")}">
                    </a>
                    <div class='avt-info'>
...
function commentPostHandle(viewPost, viewWithCmt){
    function showComment(post){
        ...
        if (post.querySelectorAll(".comment-section").length == 0 || viewWithCmt){
            post.insertAdjacentHTML('beforeend', `<div class="comment-section mg-l-lg mg-r-lg border-t"><div class="comment-textarea-frame d-flex-start pd-b pd-t"><a class="avt d-flex"><img src="${document.querySelectorAll(".user-avt")[0].getAttribute('src')}"><img src="https://cdn.lingyo.vn/lingyo-media/${document.querySelectorAll(".avt-rank")[0].getAttribute('src')}.png" class="avt-rank ${document.querySelectorAll(".avt-rank")[0].getAttribute('src')}"></a><textarea type="text" name="comment" class="mg-l-sm comment-textarea d-flex-col" maxlength="1000" placeholder="Viết bình luận..."></textarea><button class="comment-emoji-but comment-emoji emoji-but d-flex"><span class="iconify" data-icon="bi:emoji-smile" data-inline="false"></span></button></div><div class="comment-loading d-flex pd-b"><span class="iconify spin loading-icon" data-icon="ant-design:loading-3-quarters-outlined" data-inline="false"></span></div></div>`)
                            ...
                            for(let i = 0; i < res.data.cmts.length; i++) {
                                ...
                                function showTextarea(focus, tag, tagUsername){
                                    ...
                                    if (comment.querySelectorAll(".comment-textarea-frame").length == 0){
                                        comment.querySelector(".rep-comment").insertAdjacentHTML('beforeend', `<div class="comment-textarea-frame d-flex-start pd-b mg-t-sm"><a class="avt d-flex rep-avt-small"><img src="${document.querySelectorAll(".user-avt")[0].getAttribute('src')}"><img src="https://cdn.lingyo.vn/lingyo-media/${document.querySelectorAll(".avt-rank")[0].getAttribute('src')}.png" class="avt-rank ${document.querySelectorAll(".avt-rank")[0].getAttribute('src')}"></a><textarea type="text" name="comment" class="mg-l-sm comment-textarea rep-comment-textarea d-flex-col" maxlength="1000" placeholder="Viết bình luận..."></textarea><button class="comment-emoji-but comment-emoji rep-comment-emoji-but emoji-but d-flex"><span class="iconify" data-icon="bi:emoji-smile" data-inline="false"></span></button></div></div></div>`)
