...
module.exports = function(email, code){
    ...
    <tr>
    <td align="center" style="padding:0px;margin:0px auto;font-size:0px;line-height:1px;padding:0px;font-size:0px;line-height:100%;padding:0px"> <a href="https://lingyo.vn" style="text-decoration:none;border-style:none;border:0px;padding:0px;margin:0px;color:#FFF6F6;text-decoration:none" target="_blank" data-saferedirecturl=""> <img src="https://cdn.lingyo.vn/lingyo-media/logo1.png" width="50px" height="50px" alt="Lingyo" title="Lingyo" style="margin:0px;padding:0px;display:inline-block;border:none;outline:none"> </a> </td>
    </tr>
    <tr>
    <td height="24" style="padding:0px;margin:0px auto;font-size:0px;line-height:1px;padding:0px"> &nbsp; </td>
    </tr>
